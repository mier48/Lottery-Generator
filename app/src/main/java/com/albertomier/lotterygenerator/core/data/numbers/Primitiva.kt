...
class Primitiva : Numbers() {
    private val numbersFileName = "primitiva_numbers.txt"
    private val reintegroFileName = "primitiva_reintegro.txt"
    private val complementarioFileName = "primitiva_complementario.txt"
